...
Data comes from finnhub.io. Free API key was required to download. The data is the 1 minute OHLC(volume) data on the free tier. The data range from 1992 throught february 2026. (march data has not yet been released as of 4.12.26)
